...
public abstract class BaseViewPagerFragment extends AbstractBaseFragment {

    protected static final String TAG = BaseViewPagerFragment.class.getSimpleName() + "TAG";
