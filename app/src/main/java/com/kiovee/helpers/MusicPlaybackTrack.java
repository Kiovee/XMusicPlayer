...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public AppUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, AppUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = AppUtils.IdType.getTypeById(in.readInt());
